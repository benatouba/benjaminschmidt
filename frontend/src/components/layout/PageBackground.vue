...
.orb-a {
  ...
  top: -30%;
  left: -20%;
  background: radial-gradient(circle at 30% 30%, rgba(34, 211, 238, 0.3), transparent 60%);
...
.orb-b {
  ...
  right: -15%;
  bottom: -20%;
  background: radial-gradient(circle at 60% 60%, rgba(99, 102, 241, 0.25), transparent 60%);
