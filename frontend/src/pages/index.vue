...
import ArticleHistorySection from "@/components/sections/ArticleHistorySection.vue";
...
import SkillBadgesSection from "@/components/sections/SkillBadgesSection.vue";
