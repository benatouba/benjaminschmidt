...
export const cvAppointments: CvAppointment[] = [
  {
    period: "08/2019 - 02/2026",
  ...
  },
  {
    ...
    location: "Potsdam",
    summary: "Developed algorithms for counterfactual climate data generation from large datasets.",
    highlights: [
...
export const honors: HonorEntry[] = [
  ...
  },
  {
    ...
    description: "Completed secondary education with grade 1.8 and international study experience.",
  },
];

export const articleHistory: ArticleHistoryItem[] = [
  {
    title:
      "Regional Dynamical Downscaling and Analysis of Water Balance Across Different Regions and Time Scales",
...
export const externalProfiles: ExternalProfileLink[] = [
  {
    label: "GitHub",
...
export const services: ResearchService[] = [
  {
